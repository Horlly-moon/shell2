...
if (!*len) /* if there is
    nothing left in the buffer, fill it */
{
    /*then b_free((void **)info->cmnd_buf);*/
    free(*buf);
    *buf = NULL;
...
/**
 * get_Input - is to get a line exempting the newline
...
/**
 * _getline - receives next line of input from standard input
